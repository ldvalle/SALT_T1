...
import edesur.t1.srv.beans.BeanPropertyAggregationStrategy;
    ...
    public void configure() throws Exception {
        ...
        from("direct:setConsultaCorteRepo")
          ...
          //.to("sql:classpath:sql/ConsultaCorteRepo.sql?dataSource=#SynergiaDS&outputType=SelectList&outputClass=edesur.t1.srv.model.ConsultaCorteRepoResponse")
			 ...
			 .otherwise()
				.enrich("sql:classpath:sql/ConsultaCorteRepo.sql?dataSource=#SynergiaDS&outputType=SelectList&outputClass=edesur.t1.srv.model.CorteRepoResultado", listaResultado )

...
import edesur.t1.srv.model.ResponseBase;
...
public final class ErrorResponse extends ResponseBase {
    ...
    public static ErrorResponse create(ErrorType type) {
        return new ErrorResponse(type.getCodigo(), type.getDescripcion());
    }

    public static ErrorResponse create(ErrorType type, String descripcion) {
        return new ErrorResponse(type.getCodigo(), descripcion);
    }
